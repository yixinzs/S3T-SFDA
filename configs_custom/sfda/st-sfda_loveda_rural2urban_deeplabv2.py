...
# Random Seed
# seed = 0
work_dir = r'/data_zs/output/loveDA_uda/rural2urban/st-sfda_roi-prop_loveda_rural2urban_deeplab_resnet_512x512_b4_dtu_lr6e-5_total_augv2_dt-st'  #_dtu-snd_nosample  _add-model-eval
name = 'st-sfda_roi-prop_loveda_rural2urban_deeplab_resnet_512x512_b4_dtu_lr6e-5_total_augv2_dt-st'  #_dtu-snd_nosample   _add-model-eval
...
resume = r'/irsa/data_zs/output/loveDA_uda/rural2urban/onlysource_rural_deeplab_512x512_b4_val-totalurban-traintotal_augv2/checkpoint/iter_21000_0.46183168743882635_checkpoint.pth' #r'/irsa/data_zs/output/tmp_debug/onlysource_potsdamIRRG_deeplabv2_resnet101_512x512_lr5e-4_b4_vaihingen-train-val_pmd/checkpoint/iter_9600_0.44926494457061356_checkpoint.pth'
model = dict(
    resume_file=resume,
    work_dir=work_dir,
