...
checkpoint_config = dict(by_epoch=False, interval=1000, max_keep_ckpts=3)  #False 40000
...
work_dir = r'/data_zs/output/loveDA_uda/rural2urban/onlysource_rural_convnext_512x512_b4_val-totalurban-traintotal_augv2_soft'  #TODO:remeber update the dirpath in custom_base.py
name = 'onlysource_rural_convnext_512x512_b4_val-totalurban-traintotal_augv2_soft'
