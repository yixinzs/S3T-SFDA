...
data = dict(
    ...
    train=dict(
        ...
        target=dict(
            type='LOVEDADataset',
            data_root='/data_zs/open_datasets/2021LoveDA_All/Urban/Total', #Total_addtest  #/data_zs/open_datasets/2021LoveDA_All/Urban/Total #/data_zs/open_datasets/2021LoveDA/Train/Urban
            img_dir='images_png',
            ann_dir='masks_png',
    ...
    val=dict(
        type='LOVEDADataset',
        data_root='/data_zs/open_datasets/2021LoveDA_All/Urban/Total',   #/data_zs/open_datasets/2021LoveDA_All/Urban/Total  #/data_zs/open_datasets/2021LoveDA/Val/Urban
        img_dir='images_png',
        ann_dir='masks_png',
