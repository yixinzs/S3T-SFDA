...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root='/data_zs/data/open_datasets/fusai_release/train',
        img_dir='images',
        ann_dir='labels',
        split='train',
    ...
    val=dict(
        type=dataset_type,
        data_root='/data_zs/data/open_datasets/fusai_release/train',  #/dataset/data/DFCT/dataset_patch_512x512/val  #/dataset/data/DFCT/dataset_patch_512x512_9-1/val
        img_dir='images',
        ann_dir='labels',
        split='val',
    ...
    test=dict(
        type=dataset_type,
        data_root='/data_zs/data/open_datasets/fusai_release/test',
        img_dir='images',
        ann_dir='labels',
        pipeline=test_pipeline))
