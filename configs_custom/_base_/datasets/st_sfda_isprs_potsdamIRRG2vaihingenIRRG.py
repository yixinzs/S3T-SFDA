...
train_strong_pipeline = [
    ...
    dict(type='RandomFlip', prob=0.5),
    dict(type='PhotoMetricDistortion'),
    dict(type='RandMixPseudo', psd_root='/data_zs/output/tmp_debug/st-sfda_roi-prop_isprs_potsdamIRRG2vaihingenIRRG_daformer_mitb2_512x512_b4_dtu_lr6e-5', classes=[0, 1, 2, 3], choice_p=[1 / 4] * 4),      #/irsa/data_zs/output/tmp_debug/sfda_isprs_potsdamIRRG2vaihingen_deeplabv2_512x512_b4_lr5e-4_neg-loass-w1_resume9600_mixlabel
