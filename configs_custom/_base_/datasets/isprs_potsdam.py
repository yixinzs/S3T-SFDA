...
data = dict(
    ...
    val=dict(
        type='IsprsDataset',
        data_root='/data_zs/data/expert_datasets/isprs_2d_semantic_splitbyfile/vaihingen/val',  #'/irsa/data_zs/data/expert_datasets/isprs_2d_semantic_splitbyfile/vaihingen/train'  #zurich_patch  #/irsa/data_zs/data/expert_datasets/ZhongKeXingTu/train_and_val
        img_dir='images',
        ann_dir='labels_gray',
        # label_map={0: [255, 0, 0],
        #            1: [0, 0, 255],
