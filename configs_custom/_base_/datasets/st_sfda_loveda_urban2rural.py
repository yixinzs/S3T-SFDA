...
data = dict(
    ...
    train=dict(
        ...
        target=dict(
            type='LOVEDADataset',
            data_root='/data_zs/open_datasets/2021LoveDA/Train/Urban',  ##/data_zs/open_datasets/2021LoveDA/Train/Rural
            img_dir='images_png',
            ann_dir='masks_png',
    ...
    val=dict(
        type='LOVEDADataset',
        data_root='/data_zs/open_datasets/2021LoveDA/Val/Rural',    #/data_zs/open_datasets/2021LoveDA/Val/Rural
        img_dir='images_png',
        ann_dir='masks_png',
