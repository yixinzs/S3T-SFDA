...
img_norm_cfg = dict(
    mean=[61.455, 64.868, 74.614], std=[32.379, 35.219, 42.206], to_rgb=False)    #mean=[123.675, 116.28, 103.53], std=[58.395, 57.12, 57.375]
...
data = dict(
    ...
    train=dict(
        ...
        target=dict(
            type='LOVEDADataset',
            data_root='/data_zs/open_datasets/2021LoveDA_All/Rural/Total',  #_addtest #/data_zs/open_datasets/2021LoveDA/Train/Rural
            img_dir='images_png',
            ann_dir='masks_png',
    ...
    val=dict(
        type='LOVEDADataset',
        data_root='/data_zs/open_datasets/2021LoveDA_All/Rural/Total',    #/data_zs/open_datasets/2021LoveDA/Val/Rural
        img_dir='images_png',
        ann_dir='masks_png',
