...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=(1024, 1024)),   #(2560, 1440)
...
data = dict(
    ...
    train=dict(
        type='PotsdamDataset',
        data_root='/data_zs/open_datasets/da/city_domain/potsdam_patch/train',
        img_dir='images',
        ann_dir='labels_gray',
        # label_map={0: [255, 0, 0],
        #            1: [0, 0, 255],
    ...
    val=dict(
        type='PotsdamDataset',
        data_root='/data_zs/open_datasets/da/city_domain/potsdam_patch/val',  #zurich_patch
        img_dir='images',
        ann_dir='labels_gray',
        # label_map={0: [255, 0, 0],
        #            1: [0, 0, 255],
