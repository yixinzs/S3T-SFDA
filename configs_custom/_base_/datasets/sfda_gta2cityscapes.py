...
crop_size = (1024, 512)  #(512, 512)
train_weak_pipeline = [
    dict(type='LoadImageFromFileCustom'),
    dict(type='LoadAnnotations'),
    # dict(type='AlbumentationAug'),
    # dict(type='LabelEncode'),
    dict(type='Resize', img_scale=(1536, 768)),  # (2560, 1440)  (1280, 720)  img_scale=(w, h)
...
train_strong_pipeline = [
    ...
    dict(type='RandomCrop', crop_size=(512, 1024)),  #, cat_max_ratio=0.75  crop_size=(h, w)
    dict(type='RandomFlip', prob=0.5),
    dict(type='PhotoMetricDistortion'),
