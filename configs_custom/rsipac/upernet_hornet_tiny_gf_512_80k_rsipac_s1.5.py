...
train_pipeline = [
    ...
    # dict(type='FDA', prob=0.2, img_dir='/data_zs/data/open_datasets/fusai_release/test/images', file='/data_zs/data/open_datasets/fusai_release/test/test.csv'),
    dict(type='AlbumentationAug'),
    dict(type='LabelEncode'),
    dict(type='RandomCrop', crop_size=(448, 448), cat_max_ratio=0.75),  #crop_size
...
name = 'hornet_tiny_80k_b12_ce_augv2_448s1.25'
