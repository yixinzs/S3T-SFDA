...
img_norm_cfg = dict(
    mean=[63.212, 66.722, 76.747], std=[31.101, 33.943, 40.848], to_rgb=False)  #True
train_pipeline = [
    ...
    # dict(type='RandomNormalize', mean_a=[63.212, 66.722, 76.747], std_a=[31.101, 33.943, 40.848], mean_b=[54.202, 62.012, 69.253], std_b=[21.089, 24.203, 31.311], to_rgb=False),  #, mean_b=[54.202, 62.012, 69.253], std_b=[21.089, 24.203, 31.311]  #, bias=10
    dict(type='DynamicNormalize', **img_norm_cfg, file=r'/data_zs/output/rsipac_semi/config/train_name_meanstd.json'),
...
test_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='RandomFlip'),
            # dict(type='Normalize', **img_norm_cfg),
            dict(type='DynamicNormalize', **img_norm_cfg, file=r'/data_zs/output/rsipac_semi/config/test_name_meanstd.json'),
            dict(type='ImageToTensor', keys=['img']),
            dict(type='Collect', keys=['img']),
        ])
]
...
name = 'convnext_tiny_80k_b10_poly_Softce_fda-cutreplace_classmix14_dynamorm_448s1.25_fold0'
