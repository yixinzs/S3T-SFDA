...
def parse_args():
    ...
    parser.add_argument('--config', default='/data_zs/output/rsipac_semi/checkpoint/convnext_base_80k_ce/upernet_convnext_base_512_160k_rsipac_ms.py', help='test config file path')
    parser.add_argument('--checkpoint', default='/data_zs/output/rsipac_semi/checkpoint/convnext_base_80k_ce/latest.pth', help='checkpoint file')
    parser.add_argument(
        '--work-dir',
        default='/data_zs/output/rsipac_semi/test/convnext_base_80k_ce_aug-hvs',
    ...
    parser.add_argument(
        '--show-dir', default='/data_zs/output/rsipac_semi/test/convnext_base_80k_ce_aug-hvs', help='directory where painted images will be saved')
    parser.add_argument(
        '--gpu-collect',
        action='store_true',
