...
def get_dataset(img_path, aug_test=False, distributed=None):
    ...
    if aug_test:
        ...
        ]   #0.5, 0.75, 1.0, 1.25, 1.5, 1.75   #1.0, 1.25, 1.5   #0.5, 0.75,
...
def gpu_test(model_list, data_loader, show_dir):
    ...
    for batch_indices, data in zip(loader_indices, data_loader):
        with torch.no_grad():
            ...
            dirpath = r'/data_zs/output/rsipac_semi/ensemble/Softce_fda-cutreplace-classmix14_448s1.25_swa_fold0_s2_v2'  #1
...
if __name__ == '__main__':
    ...
    save_path = r'/data_zs/output/rsipac_semi/test/Softce_fda-cutreplace-classmix14_448s1.25_swa_fold0_s2_v2'
