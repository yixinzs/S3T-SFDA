...
def parse_args():
    ...
    parser.add_argument('--work-dir', default='/data_zs/code/source_free_da/mmsegmentation_sfda/work_dirs/sfda_gta_daformer_mitb5_512x512_b4_debug', help='the dir to save logs and models')
    parser.add_argument(
