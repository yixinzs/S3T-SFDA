        ...
        pipeline=[
            ...
            dict(
                ...
                transforms=[
                    ...
                    dict(
                        type='Normalize',
                        mean=[61.455, 64.868, 74.614], std=[32.379, 35.219, 42.206],    #mean=[123.675, 116.28, 103.53], std=[58.395, 57.12, 57.375],   mean=[61.455, 64.868, 74.614], std=[32.379, 35.219, 42.206],
                        to_rgb=False),
...
if __name__ == '__main__':
    ...
    for model_name in tqdm(os.listdir(model_path)):
        ...
        gpu_test(model_list, data_loader, save_path_)

    '''
    rural2urban:
        daformer: /irsa/data_zs/output/loveDA_uda/rural2urban/onlysource_rural_daformer_mitb2_512x512_b4_val-totalurban-traintotal/onlysource_rural_daformer.py
        convnext: /irsa/data_zs/output/loveDA_uda/rural2urban/onlysource_rural_convnext_512x512_b4_val-totalurban-traintotal/onlysource_rural_convnext.py
    urban2rural:
        daformer: /irsa/data_zs/output/loveDA_uda/urban2rural/onlysource_urban_daformer_mitb2_512x512_b4_val-totalrural/onlysource_urban_daformer.py
        convnext: /irsa/data_zs/output/loveDA_uda/urban2rural/onlysource_urban_convnext_512x512_b4_val-totalrural-traintotal/onlysource_urban_convnext.py
    '''
