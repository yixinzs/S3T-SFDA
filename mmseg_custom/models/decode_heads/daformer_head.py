...
from mmseg_custom.models.decode_heads.isa_head import ISALayer
...
from mmseg_custom.models.decode_heads.segformer_head import MLP
...
class DAFormerHead(DACSBaseDecodeHead):
    ...
    def __init__(self, decoder_params, **kwargs):
        ...
        decoder_params = decoder_params  #kwargs['decoder_params']
