...
class ResNet(BaseModule):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
                 ...
                 norm_layer=None, uncertainty=0.0, pos=[], pretrained=None, init_cfg=None):
        ...
        #     if init_cfg is None:
        #         warnings.warn('pretrained and init_cfg are all None, please load init weights first')
    ...
    def init_weights(self):
        ...
        if self.pretrained is None:
            ...
            logger.info('Load resnet checkpoint.')
...
def _resnet(arch, block, layers, pretrained, progress, pretrained_weights, **kwargs):
    ...
    # if pretrained_weights is not None: #pretrained:
    #    print(f'----------------------------:{pretrained_weights}')
    #    load_checkpoint(model, pretrained_weights, map_location='cpu')
    if pretrained_weights is not None:
        # load_checkpoint(model, pretrained_weights, map_location='cpu')
        pretrain_model_dict = torch.load(pretrained_weights, map_location='cpu')
        ...
        for item, value in model.state_dict().items():
            if item in pretrain_model_dict.keys() and value.shape == pretrain_model_dict[item].shape:
                ...
                print(item)
        msg = model.load_state_dict(load_model_dict, strict=False)
        print(msg)
    return model
