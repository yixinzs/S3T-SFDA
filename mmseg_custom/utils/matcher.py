...
def batch_sigmoid_focal_loss(inputs, targets, alpha: float = 0.25, gamma: float = 2):
    ...
    # print('-----------------------------focal_pos:{},targets:{}'.format(focal_pos.shape, targets.shape))
...
class HungarianMatcher(nn.Module):
    ...
    def memory_efficient_forward(self, outputs, targets):
        ...
        indices = []
        # print('-----------------------------out_mask:{},tgt_mask:{}'.format(outputs["pred_logits"].shape, len(targets)))
        ...
        for b in range(bs):
            ...
            # print('-----------------------------b:{}, out_mask:{},tgt_mask:{}'.format(b, out_mask.shape, tgt_mask.shape))
